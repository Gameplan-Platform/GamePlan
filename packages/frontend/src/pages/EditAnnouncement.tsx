...
export default function EditAnnouncement() {
  ...
  useEffect(() => {
    ...
    api<{ announcement: { title: string; body: string } }>(
  ...
  async function handleSave() {
    ...
    try {
      ...
      navigate(`/modules/${moduleId}/announcements/${announcementId}`)
    } catch (err) {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="relative bg-white overflow-hidden" style={{ width: '440px', height: '956px', borderRadius: '55px' }}>
        ...
        {/* Back button */}
        <button
          onClick={() => navigate(`/modules/${moduleId}/announcements/${announcementId}`)}
          style={{
